...
//         (el) => el.innerText
//       ),
//       propertyType: await page.$eval(
//         "#info-reel > div:nth-child(1)>dd",
//         (el) => el.innerText
//       ),
//       bedrooms: await page.$eval(
//         "#info-reel > div:nth-child(2)>dd",
//         (el) => el.innerText
//       ),
//       bathrooms: await page.$eval(
...
//       }),
//       phoneNumber: await page.$$eval("a", (a) => {
...
//     });
//     //PROBLEM OCCURRING, button click not triggering ****** NBB *******
...
//       });
//       await page.waitForTimeout(1000); // Wait for 1 seconds for sale history to load
//       propertyData.saleHistory = await page.evaluate(() => {
//         let salesArray = [];
//         try {
//           historicSales = document
//             .evaluate(
...
//             year = element.querySelectorAll("td")[0].innerText;
//             price = element.querySelectorAll("td")[1].innerText;
...
//   nextUrl = URLS[2];
//   data = await inspectIndividualProperty(nextUrl);
//   console.log(data);
//   addObjectToJSONArray("individual_property_data.json", await data);
// })();
